...
Feature: Testing an order with 1 products
	Scenario: 1st 1 product order for user 2
		Given codebase is version 1
		And user is type basic
		When user adds product to cart
		Then cart should have at least 1 products
...
Feature: Testing an order with 1 products
	Scenario: 2nd 1 product order for user 2
		Given codebase is version 1
		And user is type basic
		When user adds product to cart
		Then cart should have at least 1 products
...
Feature: Testing an order with 1 products
	Scenario: 3rd 1 product order for user 2
		Given codebase is version 1
		And user is type basic
		When user adds product to cart
		Then cart should have at least 1 products
...
Feature: Testing an order with 1 products
	Scenario: 4th 1 product order for user 2
		Given codebase is version 1
		And user is type basic
		When user adds product to cart
		Then cart should have at least 1 products
